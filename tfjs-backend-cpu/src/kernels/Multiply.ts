...
import {BinaryInputs, KernelConfig, KernelFunc, Multiply, TensorInfo, TypedArray, upcastType} from '@tensorflow/tfjs-core';
...
const multiply_: KernelFunc = ({inputs, backend}) => {
